                ...
                <div class="limiter">
                    ...
                    <?php
                        ...
                        if(isset($_POST["submit"])){
                            $str = $_POST["search"];
                            $sth = $con->prepare("select * from resolib where f_name = '$str' or course_name = '$str' or f_topic = '$str' or faculty_id = '$str' or Roll_number = '$str'");
                            ...
                            if($row = $sth->fetch()){
                                ...
                                <table>
                                        ...
                                        <th class="column4">File Topic</th>
                                        <th class="column5">Faculty_id</th>
                                        <th class="column5">Roll_Number</th>
