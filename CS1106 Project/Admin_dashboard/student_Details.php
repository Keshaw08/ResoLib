        ...
        <main>
            ...
            <div class="table">
                ...
                <table>
                    ...
                    $sql = "select Roll_number,username,email_id,password, phone_number from student_login";
                    $result = $con-> query($sql);

                    if($result-> num_rows > 0) {
                        while ($row =$result-> fetch_assoc()){
                            echo "<tr><td>". $row["Roll_number"]."</td><td>". $row["username"]. "</td><td>".$row["email_id"]. "</td><td>".$row["password"]. "</td><td>".$row["phone_number"]. "</td><td>";
                        }
                        echo "</table>";
