...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div class="div1">
      ...
      $sql1="SELECT f_name, username, email_id, department,f_topic from faculty_login,resolib where faculty_login.faculty_id = resolib.faculty_id and course_name = 'DBMS'";
    ...
    <div class="dashboard" style="margin-left:-12%;">
      ...
      $sql="SELECT f_name, username, email_id,f_topic from student_login,resolib where student_login.Roll_number = resolib.Roll_number and course_name = 'DBMS'";
